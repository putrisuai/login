...
public class TambahMahasiswaActivity extends AppCompatActivity {
    ...
    private EditText _alamatEditText, _namaEditText, _nimEditText, _tahunMasukEdiText, _tanggalLahirEditText;
    ...
    private void initSaveButton() {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String tahunMasuk = _tahunMasukEdiText.getText().toString();
    ...
    private void initInputs() {
        ...
        _tahunMasukEdiText = findViewById(R.id.tahunMasukEditText);
